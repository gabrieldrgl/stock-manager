class VariationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @variation.save
        format.html { redirect_to variation_url(@variation), notice: "Variation was successfully created." }
  ...
  def update
    respond_to do |format|
      if @variation.update(variation_params)
        format.html { redirect_to variation_url(@variation), notice: "Variation was successfully updated." }
  ...
  private
    ...
    def variation_params
      params.require(:variation).permit(:product_id, :size, :quantity)
    end
end
